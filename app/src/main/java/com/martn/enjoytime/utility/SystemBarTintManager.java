...
public class SystemBarTintManager {
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            try {
                ...
                sNavBarOverride = (String) m.invoke(null, "ro.miui.ui.version.name");
            } catch (Throwable e) {
     ...
     * @param res----对应的显示的颜色
     */
    public static void setMIUIbar(Activity activity,int res) {
...
//            manager.setStatusBarDarkMode(1, paramActivity);
        }
